...
namespace Crucigrama
{
    ...
    {
        const string PREGUNTA_1 = "FALSAPOSICION";
        const string PREGUNTA_2 = "BISECTRIZ";
        const string PREGUNTA_3 = "NEWTONRAPHSON";
        const string PREGUNTA_4 = "PUNTOFIJO";
        const string PREGUNTA_5 = "GRAFICO";
        const string PREGUNTA_6 = "SECANTE";
        ...
        {
            InitializeComponent();
            imgBox.Image = Crucigrama.Properties.Resources.N2_1;
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                imgBox.Image = Crucigrama.Properties.Resources.N2_2;
            ...
            {
                imgBox.Image = Crucigrama.Properties.Resources.N2_3;
            ...
            {
                imgBox.Image = Crucigrama.Properties.Resources.N2_4;
            ...
            {
                imgBox.Image = Crucigrama.Properties.Resources.N2_5;
            ...
            {
                imgBox.Image = Crucigrama.Properties.Resources.N2_6;
        ...
        private void ConstructorRespuestas()
        {
            ...
            this.respuesta3 = res3_1.Text + res3_2.Text + res3_3.Text + res3_4.Text + res3_5.Text +
                ...
                res3_12.Text + res3_13.Text;

            this.respuesta4 = res4_1.Text + res4_2.Text + res3_6.Text + res4_3.Text + res4_4.Text +
                res4_5.Text + res4_6.Text + res4_7.Text + res4_8.Text;

            this.respuesta5 = res5_1.Text + res3_7.Text + res5_2.Text + res5_3.Text + res5_4.Text +
                res5_5.Text + res5_6.Text;

            this.respuesta6 = res3_11.Text + res6_1.Text + res6_2.Text + res6_3.Text + res6_4.Text +
                res6_5.Text + res6_6.Text;
        }
        ...
        private void HabilitarPreguntas(int respuesta = 0, bool habilitar = false)
        {
            ...
            if (respuesta == 1)
            {
                ...
                res1_6.Enabled = res1_7.Enabled = res1_8.Enabled = res1_9.Enabled = res1_10.Enabled = res1_11.Enabled =
                res1_12.Enabled = res1_13.Enabled = habilitar;
            }

            if (respuesta == 2)
            {
                res2_1.Enabled = res2_2.Enabled = res2_3.Enabled = res2_4.Enabled = res2_5.Enabled =
                    res2_6.Enabled = res2_7.Enabled = res2_8.Enabled = res2_9.Enabled = habilitar;
            }
            ...
            if (respuesta == 3)
            {
                res3_1.Enabled = res3_2.Enabled = res3_3.Enabled = res3_4.Enabled = res3_5.Enabled =
                    ...
                    res3_12.Enabled = res3_13.Enabled = habilitar;
            }

            if (respuesta == 4)
            {
                res4_1.Enabled = res4_2.Enabled = res4_3.Enabled = res4_4.Enabled =
                res4_5.Enabled = res4_6.Enabled = res4_7.Enabled = res4_8.Enabled = habilitar;
            }

            if (respuesta == 5)
            {
                res5_1.Enabled = res5_2.Enabled = res5_3.Enabled = res5_4.Enabled =
                res5_5.Enabled = res5_6.Enabled = habilitar;
            }

            if (respuesta == 6)
            {
                res6_1.Enabled = res6_2.Enabled = res6_3.Enabled = res6_3.Enabled =
                res6_4.Enabled = res6_5.Enabled = res6_6.Enabled = habilitar;
            }
        }
